...
class EventRegisterForm extends Component {
    ...
    handleClickOpen = () => this.setState({formOpen: true})

    handleClose = () => this.setState({formOpen: false})

    validateForm = (data) => {
        const { participantName, participantAge, participantPhoneNumber, 
            participantCollegeName, participantCollegeId } = data;
        let participantNameError = "", participantAgeError = "", participantPhoneNumberError = "", 
        participantCollegeNameError = "", participantCollegeIdError = "", error = false;
                ...
                <Box
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={8} sm={8} md={10}>
                            ...
                            />
                            <div className={styles.invalid__feedback}>{this.state.errors.participantName}</div>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={12}>
                            <TextField
                                ...
                                inputProps={{ maxLength: 50 }}
                            />
                            <div className={styles.invalid__feedback}>{this.state.errors.participantCollegeName}</div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <TextField
                            ...
                            />
                                <div className={styles.invalid__feedback}>{this.state.errors.participantPhoneNumber}</div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <TextField
                                ...
                                inputProps={{ maxLength: 50 }}
                            />
                            <div className={styles.invalid__feedback}>{this.state.errors.participantCollegeId}</div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <FormControlLabel
